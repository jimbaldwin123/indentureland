      ...
      <div class="container">
        <div class="row" id="copyright-note">
          <span>
            ...
            <?php echo esc_html_e(' | WordPress Theme by', 'feather-magazine') ?> <a rel="nofollow" href="<?php echo esc_url('https://superbthemes.com/', 'feather-magazine'); ?>"><?php echo esc_html_e(' Superb WordPress Themes', 'feather-magazine') ?></a>          </span>
            <div class="top">
  ...
  <div class="wrap about-wrap feather-magazine-add-css">
      ...
      <div class="feature-section three-col">
        ...
        <div class="col">
          <div class="widgets-holder-wrap">
            ...
            <p><a target="blank" href="<?php echo esc_url('https://wordpress.org/support/theme/feather-magazine/reviews/', 'feather-magazine'); ?>" class="button button-primary">
    ...
    <table class="wp-list-table widefat">
      ...
      <tbody>
        ...
        <tr>
          <td><?php echo esc_html_e("Fully SEO Optimized  ", "feather-magazine"); ?></td>
          <td><span class="cross"><img src="<?php echo esc_url( get_template_directory_uri() . '/icons/cross.png' ); ?>" alt="<?php echo esc_html_e("No", "feather-magazine"); ?>" /></span></td>
          <td><span class="checkmark"><img src="<?php echo esc_url( get_template_directory_uri() . '/icons/check.png' ); ?>" alt="<?php echo esc_html_e("Yes", "feather-magazine"); ?>" /></span></td>
        </tr>
        <tr>
        ...
        <tr>
          <td><?php echo esc_html_e("Access All Child Themes   ", "feather-magazine"); ?></td>
          <td><span class="cross"><img src="<?php echo esc_url( get_template_directory_uri() . '/icons/cross.png' ); ?>" alt="<?php echo esc_html_e("No", "feather-magazine"); ?>" /></span></td>
          <td><span class="checkmark"><img src="<?php echo esc_url( get_template_directory_uri() . '/icons/check.png' ); ?>" alt="<?php echo esc_html_e("Yes", "feather-magazine"); ?>" /></span></td>
        </tr>
        <tr>
          <td><?php echo esc_html_e("Importable Demo Content", "feather-magazine"); ?></td>
          <td><span class="cross"><img src="<?php echo esc_url( get_template_directory_uri() . '/icons/cross.png' ); ?>" alt="<?php echo esc_html_e("No", "feather-magazine"); ?>" /></span></td>
          <td><span class="checkmark"><img src="<?php echo esc_url( get_template_directory_uri() . '/icons/check.png' ); ?>" alt="<?php echo esc_html_e("Yes", "feather-magazine"); ?>" /></span></td>
        </tr>
    ...
    <div class="feather-magazine-button-container">
      <a target="blank" href="<?php echo esc_url('https://superbthemes.com/feather-mag/', 'feather-magazine'); ?>" class="button button-primary">
        <?php echo esc_html_e("GO PREMIUM", "feather-magazine"); ?>
      </a>
    </div>
  </div>
  <?php
